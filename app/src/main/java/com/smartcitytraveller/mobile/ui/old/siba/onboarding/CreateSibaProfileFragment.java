package com.smartcitytraveller.mobile.ui.old.siba.onboarding;
...
import com.smartcitytraveller.mobile.ui.old.siba.EligibilityResponse;
                    ...
                    sibaViewModel.hitCreateSibaProfileApi(authentication, new CreateSibaProfileDTO(subject, "ZAR", invites)).observe(getViewLifecycleOwner(), responseDTO -> {
                        switch (responseDTO.getStatus()) {
                            ...
                            case "error":
                                ...
                                alertDialog.setTitle("SmartCityTraveller Alert");
