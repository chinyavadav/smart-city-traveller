package com.smartcitytraveller.mobile.ui.old.siba.profile;
...
import com.smartcitytraveller.mobile.api.dto.siba.SibaProfileMember;
import com.smartcitytraveller.mobile.common.Common;
import com.smartcitytraveller.mobile.common.Constants;
import com.smartcitytraveller.mobile.database.SharedPreferencesManager;
import com.smartcitytraveller.mobile.ui.old.siba.SibaViewModel;
 ...
 */
public class SibaProfileMembersFragment extends Fragment {
    private static final String TAG = SibaProfileMembersFragment.class.getSimpleName();
    ...
    List<SibaProfileMember> sibaProfileMembers;
    SibaProfileMembersRecyclerAdapter sibaProfileMembersRecyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_siba_profile_members, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        sibaProfileMembers = sibaProfile.getMembers();

        UUID adminProfileId = (profileDTO.getProfileId() == sibaProfile.getAdminProfileId()) ? profileDTO.getProfileId() : null;
        sibaProfileMembersRecyclerAdapter = new SibaProfileMembersRecyclerAdapter(getContext(), sibaProfileMembers, adminProfileId, fragmentManager);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        RecyclerView recyclerViewProfiles = view.findViewById(R.id.recycler_view_siba_profile_members);
        recyclerViewProfiles.setAdapter(sibaProfileMembersRecyclerAdapter);
